...
public class WebShopSeleniumTest {
    ...
    public void setUp() {
        ...
        // делает задержку страницы на 10 секунд
    ...
    public void tearDown() {
        // driver.quit(); //all & close browser
        driver.close();  // only one tab(if tan only one -> close browser) - закрывает только
        // одну текущую вкладку
    }
}
